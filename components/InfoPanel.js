...
class InfoPanel extends React.Component {
  ...
  render() {
    console.log('rererer', this.props.width);
    ...
    return (
      <View style={{ backgroundColor: 'black', width: 300 }}>
        {title && (
        ...
        <View style={{ width: '100%', height: '100%' }}>
          {console.log(infoPanel.sections[this.state.section])}
          <Text style={{margin: 20}}>{infoPanel.sections[this.state.section].text}</Text>
        </View>
